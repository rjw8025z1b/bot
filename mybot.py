...
from telegram.ext import InlineQueryHandler, CommandHandler, MessageHandler, Filters, CallbackQueryHandler, Handler
...
def start(update_obj, context):
    keyboard = [[telegram.KeyboardButton("Weather"),
    ...
    update_obj.message.reply_text("Hello there! I'm a bot. Please choose command below",
        reply_markup=reply_markup
    )

def getNumber(update, context):
    update.message.reply_text("It will be soon!")




# The entry function
def calculate(update_obj, context):
...
handler = telegram.ext.ConversationHandler(
      entry_points=[telegram.ext.CommandHandler('calculate', calculate)],
      states={
...
dispatcher.add_handler(CommandHandler('getNumber', getNumber))
